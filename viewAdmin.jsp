        ...
        <center>
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td><a href="deleteAdmin.jsp?id=<%=resultSet.getString("id")%>"><button class ="button" onclick="return confirm('Proceed to Delete?')">Delete Data</button>

                            <a href="updateAdmin.jsp?id=<%=resultSet.getString("id")%>"><button class ="buttonupdate" onclick="return confirm('Proceed to Update?')">Update Data</button>  </td>
